export default function SkeletonSlide() { 
  return (
    <section className="min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-slate-900 to-cyan-700">
      <div className="relative z-10 flex gap-8">
        ...
        <div className="block md:hidden">
          ...
          >
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-400 to-cyan-400 animate-pulse mb-4" />
