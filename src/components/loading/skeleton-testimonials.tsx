            ...
            <div key={i} className="bg-white rounded-2xl shadow-lg transition-all duration-300 border border-[#11B4D9]/10 relative animate-fade-in">
              <div className="p-8">
                <div className="absolute -top-3 -right-3">
                  <div className="bg-gradient-to-r from-amber-400 to-orange-400 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg animate-pulse w-24 h-6" />
                </div>
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#035AA6] to-[#11B4D9] rounded-full animate-pulse" />
                    <div>
