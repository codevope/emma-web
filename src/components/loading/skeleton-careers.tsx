    ...
    <section className="py-12 bg-gradient-to-br from-gray-900 to-blue-900 text-white">
      <div className="container mx-auto px-6 lg:px-8">
          ...
          {[1,2,3].map((i) => (
            <div key={i} className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 transition-all duration-300 animate-fade-in p-6 flex flex-col gap-4">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-[#035AA6] to-[#07598C] rounded-lg animate-pulse mr-3" />
                <div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-amber-500 to-orange-500 rounded-xl p-6 max-w-3xl mx-auto animate-pulse">
