...
export default function Slides() {
  ...
  // Inicializa el engine de partículas con el preset slim
  useEffect(() => {
    ...
    <section className="relative">
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          {/* Floating Orbs */}
          <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-[#035AA6]/20 to-[#11B4D9]/20 rounded-full blur-3xl animate-pulse" />
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-[#07598C]/20 to-[#038C7F]/20 rounded-full blur-3xl animate-pulse" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-r from-[#11B4D9]/10 to-[#035AA6]/10 rounded-full blur-3xl animate-pulse" />
              ...
              <div className="flex flex-col justify-center md:mt-12 lg:mt-0">
                <MotionFadeUp delay={0.1} key={slide.id}>
                  <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-2 leading-tight animate-pulse">
                    <span className="bg-gradient-to-r from-white via-[#11B4D9] to-white bg-clip-text text-transparent drop-shadow-2xl">
                      {slide.title}
                    </span>
                  </h1>
                  ...
                  <div className="flex flex-col sm:flex-row gap-6">
                    <Button
                      asChild
                      className="relative bg-gradient-to-r from-[#035AA6] via-[#11B4D9] to-[#07598C] text-white px-6 py-6 rounded-2xl font-bold shadow-2xl hover:shadow-[#11B4D9]/25 transition-all duration-500 hover:scale-105 hover:-translate-y-1"
                    >
...
function DashboardVisual() {
  return (
    <div>
      ...
      {/* Performance */}
      <div className="bg-gradient-to-br from-[#0D0D0D]/30 to-[#035AA6]/30 rounded-2xl p-4 border border-[#07598C]/30">
        ...
        <div className="relative w-full bg-[#0D0D0D] rounded-full h-3 overflow-hidden">
          <div
            className="absolute inset-0 bg-gradient-to-r from-[#11B4D9] to-[#035AA6] rounded-full animate-pulse shadow-lg shadow-[#11B4D9]/50"
            style={{ width: "92%" }}
          />
          <div
            className="absolute inset-0 bg-gradient-to-r from-[#11B4D9]/50 to-[#035AA6]/50 rounded-full animate-pulse [animation-delay:500ms]"
            style={{ width: "92%" }}
          />
        </div>
      </div>
...
function MetricCard({
  ...
  return (
    <div
      className={`group bg-gradient-to-br ${t.from} rounded-2xl p-4 border border-[#07598C]/50 ${t.borderHover} transition-all duration-300 [transform:translateZ(0)]`}
    >
      <div className="flex items-center justify-between mb-4">
  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        ...
        <Card className="relative bg-gradient-to-r from-slate-800/80 to-slate-700/80 border-slate-600/50">
          <CardContent className="p-6">
            <Badge className="absolute -top-2 -right-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white shadow-lg">
              Próximamente
            </Badge>
        ...
        >
          <div className="flex items-center justify-between">
            <div className="w-96 bg-slate-700 rounded-full h-4 overflow-hidden">
              <div
                className="bg-gradient-to-r from-green-400 to-emerald-500 h-4 rounded-full shadow-lg shadow-green-500/30 animate-pulse"
                style={{ width: "78%" }}
              />
            </div>
            <div className="text-right">
...
function TeamCard({
  ...
  return (
    <div
      className={`group bg-gradient-to-br from-slate-800/60 to-slate-700/60 rounded-2xl p-4 border border-slate-600/50 ${borderHover[tone]} transition-all duration-300 hover:scale-105`}
    >
      <div className="flex items-center gap-3 mb-3">
        <div className="relative">
          <div
            className={`w-12 h-12 bg-gradient-to-br ${halo[tone]} rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg`}
          >
            {initials}
          </div>
          <div
...
function TechCard({
  ...
  return (
    <div className="group bg-gradient-to-br from-slate-800/60 to-slate-700/60 rounded-2xl p-6 border border-slate-600/50 transition-all duration-300 hover:scale-105 cursor-pointer relative">
      {badge ? (
        <Badge
          className={`absolute -top-2 -right-2 bg-gradient-to-r ${badgeClass} text-white shadow-lg `}
        >
          {badge}
        </Badge>
      ) : null}
      <div className="flex items-center gap-4 mb-4">
        <div
          className={`w-12 h-12 bg-gradient-to-br ${halo} rounded-xl flex items-center justify-center shadow-lg`}
        >
          {icon}
        </div>
        <div>
