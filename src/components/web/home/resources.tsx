...
export default function Resources() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#11B4D9]/10 to-[#035AA6]/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Newsletter */}
        <motion.div variants={item} initial="hidden" whileInView="show" viewport={{ once: true }} className="bg-gradient-to-r from-blue-900 to-cyan-900 rounded-3xl p-12 text-white text-center">
    ...
    <Card className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-[#11B4D9]/10">
      <CardContent className="p-8">
        <div className="flex items-center mb-6">
          <div className={`w-16 h-16 bg-gradient-to-br ${gradient} rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform`}>
            {icon}
          </div>
          <div>
