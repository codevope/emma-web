  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* CTA */}
        <div className="relative overflow-hidden bg-gradient-to-r from-[#035AA6] via-[#11B4D9] to-[#07598C] rounded-3xl p-12 text-center text-white">
          {/* Decorativos */}
    ...
    <Card className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105">
      <CardContent className="p-8">
        <div className="flex flex-col items-center text-center">
          <div className={`w-20 h-20 bg-gradient-to-br ${gradient} rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
            {icon}
          </div>
