...
export default function Testimonials() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-white via-gray-50 to-[#11B4D9]/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#035AA6] to-[#11B4D9]">
              Clientes
            </span>
          </h2>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-[#035AA6] to-[#11B4D9] rounded-full flex items-center justify-center text-white font-bold text-lg">
                        {t.name.charAt(0)}
                      </div>
                      <div>
        ...
        {testimonialsData.length > visibleCount && (
          <div className="text-center">
            <Button
              onClick={loadMore}
              className="bg-gradient-to-r from-[#035AA6] to-[#11B4D9] text-white px-8 py-6 rounded-xl font-semibold hover:from-[#07598C] hover:to-[#11B4D9] transition-all duration-300 shadow-lg hover:shadow-xl"
            >
        ...
        {/* Stats */}
        <div className="mt-20 bg-gradient-to-r from-[#035AA6] via-[#11B4D9] to-[#07598C] rounded-3xl p-12 text-white">
