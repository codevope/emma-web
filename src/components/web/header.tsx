          ...
          <div className="hidden md:flex items-center space-x-3">
            {isLoading ? (
              ...
              <>
                ...
                <Button
                  asChild
                  className="bg-gradient-to-r from-[#035AA6] to-[#11B4D9] text-white px-6 py-2.5 rounded-xl shadow-lg hover:shadow-xl hover:from-[#07598C] hover:to-[#11B4D9]"
                >
                  <Link
                    href="/contact"
                ...
                <div className="px-6 py-6 border-t border-[#11B4D9]/20 bg-[#11B4D9]/5">
                  {isAuthenticated ? (
                    ...
                    <>
                      ...
                      <Button
                        asChild
                        className="w-full bg-gradient-to-r from-[#035AA6] to-[#11B4D9] text-white px-6 py-3 rounded-xl font-medium shadow-lg hover:shadow-xl hover:from-[#07598C] hover:to-[#11B4D9]"
                      >
                        <Link
                          href="/contact"
