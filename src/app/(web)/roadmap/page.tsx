...
export default function RoadmapPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-[#11B4D9]/10">
      {/* Hero Section */}
      <section className="py-20 bg-gradient-to-br from-[#035AA6] via-[#07598C] to-[#11B4D9] text-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="text-5xl font-bold mb-6">
            El Futuro de{" "}
            <span className="bg-gradient-to-r from-[#11B4D9] to-[#038C7F] bg-clip-text text-transparent">
              EMMA
            </span>
          </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-gradient-to-br from-[#035AA6]/10 to-[#07598C]/10 rounded-xl border border-[#035AA6]/30">
            ...
            <div className="text-center p-6 bg-gradient-to-br from-[#11B4D9]/10 to-[#038C7F]/10 rounded-xl border border-[#11B4D9]/30">
            ...
            <div className="text-center p-6 bg-gradient-to-br from-[#038C7F]/10 to-[#035AA6]/10 rounded-xl border border-[#038C7F]/30">
            ...
            <div className="text-center p-6 bg-gradient-to-br from-[#07598C]/10 to-[#11B4D9]/10 rounded-xl border border-[#07598C]/30">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative">
            ...
            <div className="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-[#038C7F] via-amber-400 to-[#07598C]" />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {/* Gestión de Personal */}
            <div className="bg-gradient-to-br from-[#035AA6]/10 to-[#11B4D9]/10 rounded-2xl p-8 border border-[#035AA6]/30">
            ...
            <div className="bg-gradient-to-br from-[#038C7F]/10 to-[#11B4D9]/10 rounded-2xl p-8 border border-[#038C7F]/30">
              <div className="flex items-center mb-6">
            ...
            {/* Tiempo y Asistencia */}
            <div className="bg-gradient-to-br from-[#11B4D9]/10 to-[#07598C]/10 rounded-2xl p-8 border border-[#11B4D9]/30">
              <div className="flex items-center mb-6">
            ...
            <div className="bg-gradient-to-br from-[#07598C]/10 to-[#038C7F]/10 rounded-2xl p-8 border border-[#07598C]/30">
              <div className="flex items-center mb-6">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#035AA6] to-[#11B4D9] text-white">
