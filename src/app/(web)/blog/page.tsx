  ...
  return (
    <main>
      ...
      <div className="container mx-auto px-4 py-16">
                ...
                <article className="grid items-center gap-0 lg:grid-cols-2 min-h-[400px]">
                  ...
                  <div className="relative h-full min-h-[400px]">
                    {featured.files && featured.files.length > 0 ? (
                      <div className="h-full w-full overflow-hidden rounded-l-3xl relative">
                        ...
                        <div className="absolute inset-0 opacity-20 pointer-events-none mix-blend-multiply">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-b from-amber-900/10 via-transparent to-amber-900/10 bg-repeat" 
                               style={{ backgroundSize: '100% 2px' }} />
                          
                          {/* Patrón de rayas verticales */}
                          <div className="absolute inset-0 bg-gradient-to-r from-amber-800/5 via-transparent to-amber-800/5 bg-repeat" 
                      ...
                      <div className="h-full w-full bg-gradient-to-br from-[#035AA6]/10 via-[#11B4D9]/10 to-[#07598C]/10 rounded-l-3xl flex items-center justify-center relative overflow-hidden">
                        <div className="absolute inset-0 opacity-30">
                          <div className="w-full h-full bg-gradient-to-br from-[#035AA6]/10 to-[#11B4D9]/10" 
                               style={{
                    ...
                    <div className="absolute top-6 left-6">
                      <span className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#035AA6] to-[#11B4D9] px-4 py-2 text-white font-semibold shadow-lg">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-center justify-between pt-6 border-t border-gray-100">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 bg-gradient-to-r from-[#035AA6] to-[#11B4D9] rounded-full flex items-center justify-center shadow-lg">
        ...
        {/* GRID */}
        {!loading && (
          <section className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-3xl p-8 md:p-12 shadow-xl">
            <div className="mb-8">
                      ...
                      {blog.files && blog.files.length > 0 ? (
                        <div className="aspect-[16/9] w-full overflow-hidden relative">
                          ...
                          <div className="absolute inset-0 opacity-15 pointer-events-none mix-blend-multiply">
                            {/* Patrón de rayas horizontales */}
                            <div className="absolute inset-0 bg-gradient-to-b from-amber-900/8 via-transparent to-amber-900/8 bg-repeat" 
                                 style={{ backgroundSize: '100% 2px' }} />
                        ...
                        <div className="aspect-[16/9] w-full bg-gradient-to-br from-[#035AA6]/5 via-[#11B4D9]/5 to-[#07598C]/5 flex items-center justify-center relative overflow-hidden">
                          <div className="absolute inset-0 opacity-30">
                            <div className="w-full h-full bg-gradient-to-br from-[#035AA6]/10 to-[#11B4D9]/10" 
                                 style={{
                                   backgroundImage: `radial-gradient(circle at 25% 25%, #035AA6 1px, transparent 1px), radial-gradient(circle at 75% 75%, #11B4D9 1px, transparent 1px)`,
                    ...
                    <div className="p-6 space-y-4 flex flex-col h-[calc(100%-225px)]">
                      ...
                      <div className="flex items-center mb-4 justify-between pt-4 border-t border-gray-100 mt-auto">
                        <div className="flex items-center gap-2">
                          <div className="w-8 h-8 bg-gradient-to-r from-[#035AA6] to-[#11B4D9] rounded-full flex items-center justify-center">
            ...
            <div className="mt-16 bg-gradient-to-br from-[#035AA6] via-[#07598C] to-[#11B4D9] rounded-3xl p-8 md:p-12 text-white shadow-2xl">
