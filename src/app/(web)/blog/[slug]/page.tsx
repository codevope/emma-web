    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          <div className="w-24 h-24 bg-gradient-to-r from-[#035AA6] to-[#11B4D9] rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <Link 
            href="/blog" 
            className="inline-flex items-center gap-2 bg-gradient-to-r from-[#035AA6] to-[#11B4D9] text-white px-8 py-4 rounded-2xl hover:from-[#07598C] hover:to-[#035AA6] transition-all transform hover:scale-105 shadow-lg font-semibold"
          >
            ...
            <article className="lg:col-span-2 space-y-8">
              ...
              <header className="space-y-6">
                ...
                <div className="flex flex-wrap items-center gap-4">
                  <span className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#035AA6] to-[#11B4D9] px-4 py-2 text-sm font-semibold text-white shadow-lg">
              ...
              <div className="bg-gradient-to-br from-[#035AA6] via-[#07598C] to-[#11B4D9] rounded-3xl p-8 lg:p-12 text-white shadow-2xl relative overflow-hidden">
                {/* Patrón de fondo */}
            ...
            <aside className="space-y-8">
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-gray-200/50 sticky top-24">
                ...
                <div className="space-y-6">
                  ...
                  <Link
                    href="/blog"
                    className="block w-full text-center bg-gradient-to-r from-[#035AA6] to-[#11B4D9] text-white py-3 rounded-2xl font-semibold hover:from-[#07598C] hover:to-[#035AA6] transition-all transform hover:scale-105 shadow-lg"
                  >
                    Ver todos los artículos
                  </Link>
                </div>
