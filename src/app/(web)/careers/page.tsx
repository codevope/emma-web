...
export default function CareersPage() {
  ...
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-[#035AA6] via-[#07598C] to-[#11B4D9] text-white py-20 px-4">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        jobPositions.filter((jp) => jp.isActive).length > 0 ? (
          <div className="mb-16">
            <div className="text-center mb-12">
              <span className="inline-flex items-center px-6 py-3 rounded-full text-sm font-medium bg-gradient-to-r from-[#038C7F] to-[#11B4D9] text-white mb-6 shadow-lg">
            ...
            <div className="space-y-8 max-w-7xl mx-auto">
              {jobPositions
                ...
                .map((jobPosition) => (
                  <div
                    key={jobPosition.id}
                    className="relative overflow-hidden bg-gradient-to-br from-[#035AA6] via-[#07598C] to-[#11B4D9] rounded-3xl p-1 shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-[1.02] group"
                  >
                    {/* Fondo decorativo */}
                    ...
                    <div className="relative bg-white rounded-3xl p-8 m-0.5 backdrop-blur-sm">
                      {jobPosition.isFeatured && (
                        <div className="absolute top-4 right-4">
                          <div className="inline-flex items-center bg-gradient-to-r from-[#11B4D9] to-[#038C7F] text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg">
                      ...
                      <div className="grid lg:grid-cols-3 gap-8 items-center">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                          <div className="flex items-center mb-4">
                            <div className="w-16 h-16 bg-gradient-to-br from-[#035AA6] to-[#07598C] rounded-2xl flex items-center justify-center mr-4 shadow-lg">
                        ...
                        <div className="lg:col-span-1 flex justify-center lg:justify-end">
                          <a
                            href="#careerForm"
                            className="inline-flex items-center bg-gradient-to-r from-[#035AA6] to-[#11B4D9] text-white font-bold py-4 px-8 rounded-2xl hover:from-[#07598C] hover:to-[#038C7F] transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105 group"
                          >
          ...
          <div className="mb-16 text-center">
            <div className="bg-gradient-to-br from-[#11B4D9]/10 to-[#038C7F]/5 rounded-3xl p-8 max-w-2xl mx-auto border border-[#11B4D9]/20 shadow-lg">
        ...
        <div className="grid lg:grid-cols-2 gap-16 max-w-7xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-[#035AA6]/5 via-[#11B4D9]/5 to-[#038C7F]/5 rounded-3xl p-8 shadow-xl border border-[#11B4D9]/20">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#038C7F] to-[#11B4D9] rounded-xl flex items-center justify-center mr-4 flex-shrink-0 shadow-lg">
                ...
                <div className="flex items-start">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#035AA6] to-[#07598C] rounded-xl flex items-center justify-center mr-4 flex-shrink-0 shadow-lg">
                ...
                <div className="flex items-start">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#07598C] to-[#11B4D9] rounded-xl flex items-center justify-center mr-4 flex-shrink-0 shadow-lg">
                ...
                <div className="flex items-start">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#11B4D9] to-[#038C7F] rounded-xl flex items-center justify-center mr-4 flex-shrink-0 shadow-lg">
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <div className="relative border-2 border-dashed border-[#11B4D9]/40 rounded-xl p-6 hover:border-[#035AA6] transition-colors bg-gradient-to-br from-[#11B4D9]/5 to-[#038C7F]/5">
                  <input
                    type="file"
                    id="cv"
                    name="cv"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-[#035AA6] to-[#11B4D9] text-white font-bold py-4 px-6 rounded-xl hover:from-[#07598C] hover:to-[#038C7F] transition-all duration-300 flex items-center justify-center group shadow-xl hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105"
              >
                {loading ? (
                  <>
                    <svg
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-[#11B4D9]/10 to-[#038C7F]/10 rounded-xl border border-[#11B4D9]/30">
              <div className="flex items-start">
