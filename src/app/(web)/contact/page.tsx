        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-gradient-to-r from-[#11B4D9] to-[#038C7F] text-white px-8 py-4 rounded-2xl font-semibold text-lg flex items-center shadow-xl"
            >
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          ...
          <div id="contact-info" className="space-y-8">
            <motion.div
              className="bg-gradient-to-br from-[#11B4D9]/10 to-[#038C7F]/10 rounded-2xl p-8 border border-[#11B4D9]/20"
              initial="hidden"
              whileInView="visible"
          ...
          >
            ...
            <form ref={formRef} className="space-y-6" onSubmit={handleSubmit}>
              ...
              <motion.button
                ...
                whileHover={{ y: -2 }}
                whileTap={{ scale: 0.98 }}
                className="w-full inline-flex items-center justify-center gap-2 whitespace-nowrap leading-none bg-gradient-to-r from-[#035AA6] to-[#11B4D9] text-white font-bold py-4 px-6 rounded-lg shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
        ...
        <motion.div
          ...
          variants={fadeUp}
        >
          <div className="bg-gradient-to-r from-[#035AA6] to-[#11B4D9] rounded-2xl p-8 text-white">
