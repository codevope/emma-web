  ...
  return (
    <section className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-3xl p-8 md:p-12 mb-16 shadow-xl">
                ...
                <div className="z-10">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-gradient-to-br from-[#035AA6] to-[#11B4D9] rounded-xl flex items-center justify-center shadow">
                  ...
                  <div className="space-y-4 mb-6">
                    <div>
                      ...
                      <div className="w-full bg-slate-200 rounded-full h-2 overflow-hidden">
                        <div
                          className="bg-gradient-to-r from-[#035AA6] to-[#11B4D9] h-2 rounded-full"
                          style={{ width: "92%" }}
                        />
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <Button
                      size="sm"
                      className="bg-gradient-to-r from-[#035AA6] to-[#11B4D9] text-white hover:from-[#035AA6] hover:to-[#11B4D9]"
                    >
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-[#035AA6]/10 to-[#11B4D9]/10 rounded-3xl p-8 text-center border-2 border-[#11B4D9]/20 hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="bg-gradient-to-br from-[#038C7F]/10 to-[#07598C]/10 rounded-3xl p-8 text-center border-2 border-[#038C7F]/20 hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="bg-gradient-to-br from-[#07598C]/10 to-[#11B4D9]/10 rounded-3xl p-8 text-center border-2 border-[#07598C]/20 hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
        ...
        {/* Contact Information */}
        <div className="bg-gradient-to-r from-[#035AA6] to-[#11B4D9] rounded-3xl p-8 md:p-12 text-white mb-16 shadow-2xl">
