              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {activeJobPositions.map((position) => (
                    <Card
                      key={position.id}
                      className="group hover:shadow-lg transition-all duration-300 border-green-200 bg-gradient-to-br from-white to-green-50"
                    >
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                  {inactiveJobPositions.map((position) => (
                    <Card
                      key={position.id}
                      className="group hover:shadow-md transition-all duration-300 border-gray-200 bg-gradient-to-br from-white to-gray-50 opacity-75"
                    >
                      <CardHeader className="relative pb-3">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
