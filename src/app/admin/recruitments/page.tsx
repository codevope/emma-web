                ...
                {getFileType(selectedPdfUrl) === 'pdf' ? (
                    ...
                    <div className="bg-white border-b border-gray-200 p-4">
                      <div className="grid gap-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-gradient-to-br from-[#035AA6] to-[#07598C] rounded-lg flex items-center justify-center">
                  ...
                  <div className="flex flex-col items-center justify-center h-full p-8">
                    <div className="text-center mb-8">
                      ...
                      <div className="w-32 h-32 bg-gradient-to-br from-[#11B4D9] to-[#038C7F] rounded-2xl flex items-center justify-center mb-6 mx-auto shadow-2xl">
                    ...
                    <div className="flex flex-col gap-4 w-full max-w-sm">
                      <Button
                        ...
                        size="lg"
                        onClick={() => window.open(selectedPdfUrl, "_blank")}
                        className="w-full bg-gradient-to-r from-[#035AA6] to-[#11B4D9] hover:from-[#07598C] hover:to-[#038C7F]"
                      >
                    ...
                    <div className="mt-8 p-4 bg-gradient-to-br from-[#11B4D9]/10 to-[#038C7F]/5 rounded-lg border border-[#11B4D9]/30 max-w-md">
                  ...
                  <div className="flex flex-col items-center justify-center h-full p-8">
                    <div className="text-center">
                      <div className="w-24 h-24 bg-gradient-to-br from-[#07598C] to-[#035AA6] rounded-2xl flex items-center justify-center mb-6 mx-auto">
